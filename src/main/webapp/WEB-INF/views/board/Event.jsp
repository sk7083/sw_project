		...
		<p style="font-size: 22px; font-weight: bold; margin-bottom: 40px; position: relative;">게시판 작성</p>
		  <div class="container">
  			<div class="form-group">
				...
				<input type="hidden" id="txtFavorite" value="BC00003" name="bo_ca_pid"/>
				<input type="text" class="form-control" value="이벤트" disabled="disabled" style="background-color: white;"/>
			</div>
