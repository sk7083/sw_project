      ...
      <div class="container h-100">
        <div class="home-banner">
          <div class="text-center">
            ...
            <h2 style="color: white; margin-bottom: 30px;">Event</h2>
...
<div style="display: flex;">
	<p style="font-size: 22px; font-weight: bold; margin-bottom: 40px; position: relative;">이벤트</p>
	<c:if test="${user.me_auth == 2}">
		<a href="<c:url value="/Event?ca_pid=BC0003"></c:url>" style="background: #f8f9fa; padding: 7px; border-radius: 5px; color: black; margin-left: auto; text-decoration: none; float: right; margin-bottom: 35px;">게시글 작성</a>
	</c:if>
</div>
  ...
  <table class="table table-hover">
	...
	<c:forEach items ="${boardlist}" var="b">
		<c:if test="${b.bo_ca_pid eq 'BC00003'}">
