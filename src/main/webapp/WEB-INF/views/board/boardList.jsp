...
<div style="display: flex;">
	...
	<c:if test="${user.me_auth == 2}">
		<a href="<c:url value="/Notice?ca_pid=BC0001"></c:url>" style="background: #f8f9fa; padding: 7px; border-radius: 5px; color: black; margin-left: auto; text-decoration: none; float: right; margin-bottom: 35px;">게시글 작성</a>
	</c:if>
</div>
  ...
  <table class="table table-hover">
	...
	<c:forEach items ="${boardlist}" var="b">
		<c:if test="${b.bo_ca_pid eq 'BC00001'}">
