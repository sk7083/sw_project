<%@page import="com.kh.sw.vo.ProductVO"%>
			...
			<div class="container">
				...
				<div class="form-group has-feedback" style="text-align: right;">
					<button type="submit" class="btn btn-light"
						style="margin-top: 20px" id="signup">상품 등록</button>
					<button class="btn btn-light" type="reset" style="margin-top: 20px; margin-left: 20px" onclick="location.href='/sw/productManagerInfoList'">취소</button>
				</div>
			</div>
